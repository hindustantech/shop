    ...
    return (
        <>
            ...
            <div className="nav header-dashboard color-custom d-flex justify-content-between align-items-center">
                ...
                <Link to="/" className=''>   <img src="asset/logo/37.png" alt="" className="l-h-h heade-nav" /></Link>
            ...
            <div className="container mb-4">
                ...
                <div className="profile-detail mt-2 text-center">
                    <div className="eddit">
                        ...
                        <Link to="/edditproile"> <img src="asset/logo/46.png" className=" profile-pic-edit" alt="" />  </Link>
                    </div>
                    <img src="asset/logo/22.png" alt="" className="profile-p profile-pic-height  d-inline-block" />
                    <h3 className="profile-text-color fw-bolder mt-2 p-0">{data && data.user.user && data.user.user.first_name}</h3>
                    <p className="profile-text-color">{data && data.user.user && data.user.user.email1}</p>
                </div>
